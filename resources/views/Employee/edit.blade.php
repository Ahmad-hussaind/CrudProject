                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="fname" id="fname" class="form-control" placeholder="First Name" value="{{ $employee->fname}}">
                            <p></p>	
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="lname" id="lname" class="form-control" placeholder="Last Name" value="{{ $employee->lname}}">
                            <p></p>	
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="salary" id="salary" class="form-control" placeholder="Salary" value="{{ $employee->salary}}">
                            <p></p>	
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @if(!empty($employee->profile_pic))
                           ...
                           <div>
                            <img width="200" src="{{ asset('uploads/employee/thumb/'.$employee->profile_pic) }}" alt="">
                        </div>
                        @endif
                    </div>	
                    </div>
